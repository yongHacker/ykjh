	...
	<div class="bd">
		<ul>
			{foreach $product AS $car}
				<li _src="url({PrintImageURL($car.path, $car.filename)})" style="background:#FFFFFF center 0 no-repeat;"><a href="{$car.title}"></a></li>
			{/foreach}
		</ul>
	</div>
...
<div class="jinh">
	...
	<ul class="jinh_th">
		<li class="imgl">
			<div class="imgleft"><img src="{$t_url}/images/n3.png">
		...
		<li class="imgl">
			<div class="imgleft"><img src="{$t_url}/images/n4.png">
				<div class="imgleft_name">黄金产品回购业务</div>
			</div>
			<div class="imgleft_one">闲置黄金资产盘活
			</div>
			<div class="imgleft_two">黄金产品 回购变现</div>
		</li>

		<li class="imgl">
			<div class="imgleft"><img src="{$t_url}/images/n5.png">
		...
		<li class="imgl">
			<div class="imgleft"><img src="{$t_url}/images/n6.png">
	...
	<div class="jindian_bg">
		<div class="jindian1">
			...
			<ul class="jindianimg">
				...
				<li class="jindian_img1"><img src="{$t_url}/images/ne1.png"></li>
				<li class="jindian_img2"><img src="{$t_url}/images/ne2.png"></li>
				<li class="jindian_img1"><img src="{$t_url}/images/ne3.png"></li>
...
<div class="shic">
		...
		<div class="hezuo_con">
			...
			<div class="hezuo_net">
				<ul >
					...
					{*<li class="img2"><img src="{$t_url}/images/t9.png"></li>
					<li class="img2"><img src="{$t_url}/images/t5.png"></li>
					*}
				</ul>
	...
	<script src="{$t_url}js/index.js"></script>
{include footer.tpl}
