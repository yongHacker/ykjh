...
<body>
<div id="header">
	<div class="logo" ><a href="' . BURL() . '"><img src="'. SYSDIR .'public/admin/images/adminlogin.png" title="后台首页"></a></div>
	...
	<div id="topbar">
		<div id="topmenu">
			...
			<dl>
				<dt><a href="' . BURL('products') . '">轮播图</a></dt>
				<dd>
					<div>
						<li class="first"><a href="' . BURL('products/add') . '">添加轮播图</a></li>
						<li><a href="' . BURL('products') . '">轮播图列表</a></li>
					</div>
				</dd>
			</dl>
			<dl>
...
<div id="sidebar">
	...
	<ul>
		...
		<li class="has-sub">
		   ...
		   <ul class="sub">
			  <li><a href="' . BURL('products/add') . '">添加轮播图</a></li>
			  <li><a href="' . BURL('products') . '">轮播图列表</a></li>
		   </ul>
		</li>
		<li class="has-sub">
...
<td valign="top" class="maintd">
  <div class="maindiv">
    ...
    protected function page_footer($sysinfo = ''){
		...
		echo '<div class=sysinfo>'.date("Y").' &copy;永坤金行 <a href="http://www.gold-banker.com" target="_blank">www.gold-banker.com</a> Done in '.$sys_runtime.' second(s), '.$this->db->query_nums.' queries, GMT' .$this->config['siteTimezone'].' ' .DisplayDate('', '', 1).'</div>
		</div>
  </div>
</td>
</tr>
