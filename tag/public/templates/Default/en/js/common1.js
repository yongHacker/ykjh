...
//------------------------信息提示框-----------------------------------------
//参数说明
//type 提示框类型:（1-成功，2-错误）
//msg 系统返回提示信息
//url   关闭后执行的操作
function messageBox(type,msg,url){
	require.async(['/plugins/layer-v1.8.4/skin/layer.css','/plugins/layer-v1.8.4/layer.min'],function(){
		if(type==1){
			...
			$.layer({
				...
				//time: 3,
				page: {
				      html: '<div class="tipsWin"><i class="iconfont okIco">&#xe60e;</i><span>'+msg+'</span></div>'
				  },
			...
			$.layer({
				...
				//time: 3,
				page: {
				      html: '<div class="tipsWin"><i class="iconfont errorIco">&#xe60f;</i><span>'+msg+'</span></div>'
				  }
			});
		}	
	});
