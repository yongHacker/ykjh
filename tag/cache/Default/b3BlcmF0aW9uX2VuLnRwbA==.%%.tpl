...
<div class="bannerbox">
    <div class="banner">
        <img src="<?php echo $this->_tpl_vars['t_url']; ?>/images/en_yunying.jpg">
    </div>
</div>
<!-- S 内容 -->
<style>
    ...
    <ul class="helpSubNav" id="helpSubNav">
        ...
        <?php foreach($this->_tpl_vars['article'] AS $this->_tpl_vars['p']){; ?>
            <li style="font-size: 16px; color: #000000; margin-top: 5px; cursor: pointer;">
                <a title="<?php echo $this->_tpl_vars['p']['title_en']; ?>" href="<?php PURL('operation?id=' . $this->_tpl_vars['p']['a_id']); ?>">
