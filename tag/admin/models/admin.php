...
<body>
<div id="logo">
	<img src="'. SYSDIR .'public/admin/images/adminlogin.png" alt="'.APP_NAME.'"> 
</div>
<div id="login">
...
<div id="login-copyright">
	'.date("Y").' &copy; Gold-Banker <a href="http://www.weentech.com" target="_blank">&nbsp;&nbsp;&nbsp;&nbsp;www.gold-banker.com</a>
</div>
