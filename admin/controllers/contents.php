...
class c_contents extends SAdmin{
	...
	public function save(){
		...
		if($c_id){
			...
			$this->db->exe("INSERT INTO " . TABLE_PREFIX . "content (title, title_en, keywords, keywords_en, content, content_en, created, r_id) VALUES ('$title', '$title_en', '$keywords', '$keywords_en', '$content', '$content_en', '$time', '$r_id') ");
