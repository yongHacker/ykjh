...
class c_settings extends SAdmin{
    ...
    public function index(){
		...
		$Radio ->Clear();
		$Radio->Name = 'settings[siteNewCrawler]';
		$Radio->SelectedID = $this->config['siteNewCrawler'];
		$Radio->AddOption(1, '开启', '&nbsp;&nbsp;&nbsp;&nbsp;');
		$Radio->AddOption(0, '关闭', '&nbsp;&nbsp;');
		TableRow(array('<B>爬虫抓取新闻</B><BR>开启即允许执行爬虫抓取新闻数据.(手动爬取：<a href="/index.php/actionCrawler/index?type=1"><span class=note>最新资讯</span></a>&nbsp;&nbsp;<a href="/index.php/actionCrawler/index?type=2"><span class=note>头版新闻</span></a>)', $Radio->Get()));
